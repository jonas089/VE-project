    ...
    return(
      <div>
        <div class="flex items-center justify-center px-4 sm:px-0">
          <div role="alert" id="alert" class="lg:w-10/12 transition duration-150 ease-in-out bg-red-500 shadow rounded-md md:flex justify-between items-center top-0 mt-12 mb-8 py-4 px-4">
            <div class="sm:flex items-center">
              <div class="flex items-end">
                <div class="mr-2 mt-0.5 sm:mt-0 text-red-800">
                  ...
                  <p class="mr-2 text-base font-bold text-white">Active Public Key</p>
                </div>
                <div class="h-1 w-1 bg-red-800 rounded-full mr-2 hidden xl:block"></div>
                   <p class="text-base text-black-800">{this.props.publickey}</p>
                </div>
            </div>
        </div>
      </div>
