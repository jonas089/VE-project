    ...
    return(
      <div class="mx-auto bg-gradient-to-l from-indigo-400 to-red-700">
        <div class="flex items-center justify-center px-4 sm:px-0">
          <div role="alert" id="alert" class="lg:w-10/12 transition duration-150 ease-in-out bg-black shadow rounded-md md:flex justify-between items-center top-0 mt-12 mb-8 py-4 px-4">
