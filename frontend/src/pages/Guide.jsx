...
export default class Guide extends React.Component {
  ...
  render(){
    return(
      <div className='content-center px-10 py-5 bg-black'>
        ...
        <h1 className='text-white text-2xl pt-5 pb-5 text-center'>Learn more at <a className='text-blue-400 px-1' href='https://ve.cspr.university/account'>ve.cspr.university/account</a></h1>
      </div>
    );
  }
}
