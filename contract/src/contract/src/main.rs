...
pub extern "C" fn call() {
    ...
    let minting_mode: u8 = 1;

    // nfts are transferable
    let ownership_mode: u8 = 2;

    // digital NFT
    let nft_kind: u8 = 1;

    // mixed holder mode
    let holder_mode: u8 = 2;
    ...
    // Hash identifier mode
    let identifier_mode: u8 = 1;

    // Immutable Metadata
    let metadata_mutability: u8 = 0;
